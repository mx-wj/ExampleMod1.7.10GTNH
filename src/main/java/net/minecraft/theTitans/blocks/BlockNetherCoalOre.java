...
public class BlockNetherCoalOre
extends BlockOre {
    private Random rand = new Random();

    public BlockNetherCoalOre(Material materialIn) {
        this.setHarvestLevel("pickaxe", 0);
        this.setHardness(3.0f);
        this.setResistance(5.0f);
        this.setCreativeTab(TheTitans.titansTab);
        this.setBlockName("nether_coal_ore");
        this.setBlockTextureName("thetitans:nether_coal_ore");
    ...
    public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_) {
        return MathHelper.getRandomIntegerInRange((Random)this.rand, (int)0, (int)2);
    }
