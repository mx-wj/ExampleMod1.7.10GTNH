...
public class BlockHarcadiumOre
extends BlockOre {
    private Random rand = new Random();

    public BlockHarcadiumOre(Material materialIn, String name) {
    ...
    public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_) {
        return MathHelper.getRandomIntegerInRange((Random)this.rand, (int)15, (int)50);
    }
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_) {
        ...
        if (p_149734_5_.nextInt(200) == 0) {
            p_149734_1_.playSound((double)((float)p_149734_2_ + 0.5f), (double)((float)p_149734_3_ + 0.5f), (double)((float)p_149734_4_ + 0.5f), "thetitans:harcadiumBlockHum", 1.0f, 1.0f, false);
        }
    }
