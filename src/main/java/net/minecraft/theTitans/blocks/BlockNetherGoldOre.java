...
public class BlockNetherGoldOre
extends BlockOre {
    ...
    public BlockNetherGoldOre(Material materialIn) {
        ...
        this.setBlockName("nether_gold_ore");
        this.setBlockTextureName("thetitans:nether_gold_ore");
    ...
    public int getExpDrop(IBlockAccess p_149690_1_, int p_149690_5_, int p_149690_7_) {
        return MathHelper.getRandomIntegerInRange((Random)this.rand, (int)2, (int)5);
    }
