...
public class ItemEggSnowGolemTitan
extends Item {
    public ItemEggSnowGolemTitan(String unlocalizedName) {
        this.setUnlocalizedName(unlocalizedName);
        this.setCreativeTab(TheTitans.titansTab);
        this.setTextureName("thetitans:eggsnowgolemtitan");
    }
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_) {
        EntitySnowGolemTitan entity = new EntitySnowGolemTitan(worldIn);
        ...
        if (entity != null) {
            ...
            entity.playSound("thetitans:titanBirth", 1000.0f, 1.0f);
