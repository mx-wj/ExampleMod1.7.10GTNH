...
public class ItemAdminiumPickaxe
extends ItemPickaxe {
    public ItemAdminiumPickaxe(String unlocalizedName, Item.ToolMaterial material) {
        super(material);
        this.setTextureName("thetitans:adminium_pickaxe");
    ...
    public boolean hitEntity(ItemStack stack, EntityLivingBase target, EntityLivingBase attacker) {
        ...
        if (target != null && (target.height >= 6.0f || target instanceof EntityTitan || !target.onGround)) {
            target.attackEntityFrom(DamageSourceExtra.causeAntiTitanDamage((Entity)attacker), 3.0E9f);
    ...
    public boolean onEntitySwing(EntityLivingBase entityLiving, ItemStack stack) {
        MovingObjectPosition raycast = ItemAdminiumPickaxe.raytraceFromEntity(entityLiving.worldObj, (Entity)entityLiving, true, 6.0);
