...
import net.minecraft.theTitans.world.ChunkProviderNowhere;
import net.minecraft.theTitans.world.WorldChuckNowhere;
...
extends WorldProvider {
    ...
    public Vec3 getFogColor(float p_76562_1, float p_76562_2) {
        return Vec3.createVectorHelper((double)0.196078431372549, (double)0.0196078431372549, (double)0.196078431372549);
    }
