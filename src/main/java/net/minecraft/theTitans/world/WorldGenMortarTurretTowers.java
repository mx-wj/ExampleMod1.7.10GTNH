...
public class WorldGenMortarTurretTowers
extends WorldGenerator {
    private Block field_150520_a;

    public WorldGenMortarTurretTowers(Block p_i45464_1_) {
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_) {
        if (p_76484_1_.isAirBlock(p_76484_3_, p_76484_4_, p_76484_5_) && p_76484_1_.getBlock(p_76484_3_, p_76484_4_ - 1, p_76484_5_) == this.field_150520_a) {
            ...
            EntityWitherTurretMortar entityendercrystal = new EntityWitherTurretMortar(p_76484_1_);
