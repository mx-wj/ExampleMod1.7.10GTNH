...
public class ModelWitherzillaMinion
extends ModelBase {
    private ModelRenderer[] spine;
    private ModelRenderer[] heads;

    public ModelWitherzillaMinion() {
    ...
    public void setRotationAngles(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
        float f6 = MathHelper.cos((float)(p_78087_3_ * 0.1f));
        this.spine[1].rotateAngleX = (0.065f + 0.05f * f6) * (float)Math.PI;
    ...
    public void setLivingAnimations(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
        EntityWitherzillaMinion entitywither = (EntityWitherzillaMinion)p_78086_1_;
        for (int i = 1; i < 3; ++i) {
