...
public class RenderUltimaIronGolemTitanSpawnEgg
implements IItemRenderer {
    private static final ResourceLocation eggTextures = new ResourceLocation("thetitans", "textures/entities/eggs/ultima_iron_golem_titan_egg.png");
