...
public class RenderWitherSkeletonTitanSpawnEgg
implements IItemRenderer {
    private static final ResourceLocation eggTextures = new ResourceLocation("thetitans", "textures/entities/eggs/wither_skeleton_titan_egg.png");
