...
public class RenderOmegafishSpawnEgg
implements IItemRenderer {
    private static final ResourceLocation eggTextures = new ResourceLocation("thetitans", "textures/entities/eggs/omegafish_egg.png");
