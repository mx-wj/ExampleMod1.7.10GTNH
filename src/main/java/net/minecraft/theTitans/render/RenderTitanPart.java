...
extends Render {
    ...
    private void func_147907_a(Block p_147907_1_, double p_147907_2_, double p_147907_4_, double p_147907_6_, int p_147907_8_, int p_147907_9_, int p_147907_10_, float p_147907_11_, float p_147907_12_, double p_147907_13_, double p_147907_15_, double p_147907_17_) {
        double d6;
        Tessellator tessellator = Tessellator.instance;
        if (p_147907_1_.renderAsNormalBlock() && (d6 = ((double)p_147907_11_ - (p_147907_4_ - ((double)p_147907_9_ + p_147907_15_)) / 2.0) * 0.5 * (double)this.renderManager.worldObj.getLightBrightness(p_147907_8_, p_147907_9_, p_147907_10_)) >= 0.0) {
            if (d6 > 1.0) {
                d6 = 1.0;
            }
            ...
            double d9 = (double)p_147907_9_ + p_147907_1_.getBlockBoundsMinY() + p_147907_15_ + 0.015625;
            ...
            float f2 = (float)((p_147907_2_ - d7) / 2.0 / (double)p_147907_12_ + 0.5);
            float f3 = (float)((p_147907_2_ - d8) / 2.0 / (double)p_147907_12_ + 0.5);
            float f4 = (float)((p_147907_6_ - d10) / 2.0 / (double)p_147907_12_ + 0.5);
            float f5 = (float)((p_147907_6_ - d11) / 2.0 / (double)p_147907_12_ + 0.5);
    ...
    private void renderShadow(Entity p_76975_1_, double p_76975_2_, double p_76975_4_, double p_76975_6_, float p_76975_8_, float p_76975_9_) {
        ...
        int i = MathHelper.floor_double((double)(d8 - (double)f2));
        int j = MathHelper.floor_double((double)(d8 + (double)f2));
        int k = MathHelper.floor_double((double)(d3 - (double)f2));
        int l = MathHelper.floor_double((double)d3);
        int i1 = MathHelper.floor_double((double)(d4 - (double)f2));
        int j1 = MathHelper.floor_double((double)(d4 + (double)f2));
    ...
    public void doRenderShadowAndFire(Entity p_76979_1_, double p_76979_2_, double p_76979_4_, double p_76979_6_, float p_76979_8_, float p_76979_9_) {
        double d3;
        float f2;
        if (this.shadowSize > 0.0f && !p_76979_1_.isInvisible() && (f2 = (float)(1.0 - (d3 = this.renderManager.getDistanceToCamera(p_76979_1_.posX, p_76979_1_.posY, p_76979_1_.posZ)) / 40000.0)) > 0.0f) {
    ...
    public void doRender(EntityTitanPart p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
        this.shadowSize = p_76986_1_.entityDragonObj != null && p_76986_1_.entityDragonObj instanceof EntityTitan && ((EntityTitan)((Object)p_76986_1_.entityDragonObj)).getWaiting() ? 0.0f : 1.0f + p_76986_1_.width / 2.0f;
    }
