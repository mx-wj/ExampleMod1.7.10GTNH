...
extends RenderLiving {
    ...
    public RenderZombiePigmanTitan() {
        super((ModelBase)new ModelPigZombieTitan(), 0.5f);
    }
    ...
    protected int shouldRenderPass(EntityPigZombieTitan p_77032_1_, int p_77032_2_, float p_77032_3_) {
        if (p_77032_1_.isArmored() && p_77032_1_.isEntityAlive()) {
            ...
            if (p_77032_2_ == 1) {
                ...
                GL11.glColor4f((float)(0.7f + MathHelper.cos((float)(f1 * 0.05f)) * 0.2f), (float)(0.2f + MathHelper.cos((float)(f1 * 0.05f)) * 0.2f), (float)0.0f, (float)1.0f);
