...
extends RenderLiving {
    ...
    private static final ResourceLocation spiderTextures = new ResourceLocation("thetitans", "textures/entities/titans/cave_spider_titan.png");
    private ModelBase overlayingModel = new ModelSpiderTitan(0.1f);

    public RenderCaveSpiderTitan() {
        super((ModelBase)new ModelSpiderTitan(), 0.7f);
    ...
    protected int shouldRenderPass(EntityCaveSpiderTitan p_77032_1_, int p_77032_2_, float p_77032_3_) {
        if (p_77032_1_.isArmored() && p_77032_1_.isEntityAlive()) {
            ...
            if (p_77032_2_ == 1) {
                ...
                GL11.glColor4f((float)(0.6f + MathHelper.cos((float)(f1 * 0.1f)) * 0.3f), (float)0.0f, (float)0.0f, (float)1.0f);
    ...
    protected int shouldRenderPass(EntityLivingBase p_77032_1_, int p_77032_2_, float p_77032_3_) {
        return this.shouldRenderPass((EntityCaveSpiderTitan)p_77032_1_, p_77032_2_, p_77032_3_);
    }

    protected float getDeathMaxRotation(EntityLivingBase p_77037_1_) {
        return this.getDeathMaxRotation((EntityCaveSpiderTitan)p_77037_1_);
    }

    protected ResourceLocation getEntityTexture(Entity entity) {
        return this.getEntityTexture((EntityCaveSpiderTitan)entity);
    }
    ...
    protected void preRenderCallback(EntityLivingBase p_77041_1_, float p_77041_2_) {
        this.func_180592_a((EntityCaveSpiderTitan)p_77041_1_, p_77041_2_);
    }
    ...
    public void doRender(EntityLiving entity, double x, double y, double z, float p_76986_8_, float partialTicks) {
        this.func_180579_a((EntityCaveSpiderTitan)entity, x, y, z, p_76986_8_, partialTicks);
    }
