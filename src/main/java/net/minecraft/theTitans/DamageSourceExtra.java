...
extends DamageSource {
    ...
    public static DamageSource causeAntiTitanDamage(Entity p_92087_0_) {
        return new EntityDamageSource("mob", p_92087_0_).setDamageBypassesArmor();
    }

    public static DamageSource causeHarcadiumArrowDamage(EntityHarcadiumArrow arrow, Entity p_76353_1_) {
        return new EntityDamageSourceIndirect("arrow", (Entity)arrow, p_76353_1_).setDamageAllowedInCreativeMode().setDamageBypassesArmor();
    }
