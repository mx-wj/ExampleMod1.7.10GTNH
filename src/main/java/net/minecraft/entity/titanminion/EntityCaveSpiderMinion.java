...
public class EntityCaveSpiderMinion
...
ITemplar {
    ...
    public EntityCaveSpiderMinion(World worldIn) {
        ...
        if (TheTitans.TitansFFAMode) {
            this.targetTasks.addTask(0, (EntityAIBase)new EntityAINearestTargetTitan((EntityCreature)this, EntityLivingBase.class, 0, false, false, ITitan.CaveSpiderTitanSorter));
        } else {
    ...
    public String getCommandSenderName() {
        switch (this.getMinionTypeInt()) {
            case 1: {
                return StatCollector.translateToLocal((String)"entity.CaveSpiderPriest.name");
            }
            case 2: {
                return StatCollector.translateToLocal((String)"entity.CaveSpiderZealot.name");
            }
            case 3: {
                return StatCollector.translateToLocal((String)"entity.CaveSpiderBishop.name");
            }
            case 4: {
                return StatCollector.translateToLocal((String)"entity.CaveSpiderTemplar.name");
            }
        }
        return StatCollector.translateToLocal((String)"entity.CaveSpiderLoyalist.name");
    }
    ...
    public void setMinionType(int miniontype) {
        ...
        if (miniontype == 1) {
            ...
            this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(1100.0);
            this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(30.0);
            this.getEntityAttribute(SharedMonsterAttributes.knockbackResistance).setBaseValue(1.0);
            this.isImmuneToFire = true;
            this.setHealth(1100.0f);
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (source.getEntity() instanceof EntityCaveSpiderMinion || source.getEntity() instanceof EntityCaveSpiderTitan) {
            return false;
        }
    ...
    public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_) {
        ...
        if (this.getDistanceSqToEntity((Entity)p_82196_1_) < (double)(p_82196_1_.width * p_82196_1_.width) + 36.0) {
            ...
            switch (this.rand.nextInt(6)) {
                ...
                case 4: {
                    p_82196_1_.setFire(10);
                    p_82196_1_.attackEntityFrom(DamageSource.onFire, 20.0f);
                    p_82196_1_.motionY = 1.0;
                ...
                case 5: {
                    ...
                    for (int i1 = 0; i1 < list11.size(); ++i1) {
                        ...
                        if (!(entity instanceof EntityCaveSpiderMinion) || entity == null) continue;
    ...
    public void onLivingUpdate() {
        ...
        try {
        EntityCaveSpiderMinion entitychicken;
        if (this.getMinionTypeInt() == 1) {
            this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(20.0);
            this.getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(3.0);
            this.experienceValue = 15;
        ...
        if (this.getMinionTypeInt() == 3) {
            if (this.rand.nextInt(120) == 0 && this.master == null && this.getHealth() > 0.0f && !this.worldObj.isRemote && this.worldObj.difficultySetting != EnumDifficulty.PEACEFUL) {
                entitychicken = new EntityCaveSpiderMinion(this.worldObj);
    ...
    protected void updateAITasks() {
        ...
        if (this.getAttackTarget() != null) {
            ...
            if (this.isPredator && this.getAttackTarget().getDistanceSqToEntity((Entity)this) < 25.0 && this.rand.nextInt(10) == 0) {
                ...
                vec3 = vec3.normalize();
                double d0 = 16.0;
                double d12 = this.posX + (this.rand.nextDouble() - 0.5) * 8.0 - vec3.xCoord * d0;
                EnderTeleportEvent event = new EnderTeleportEvent((EntityLivingBase)this, d12, d2 = (double)this.worldObj.getTopSolidOrLiquidBlock((int)d12, (int)(d3 = this.posZ + (this.rand.nextDouble() - 0.5) * 8.0 - vec3.zCoord * d0)), d3, 0.0f);
            ...
            if (this.getAttackTarget().getDistanceSqToEntity((Entity)this) < 256.0 && this.getAttackTarget().getDistanceSqToEntity((Entity)this) > 9.0 && this.rand.nextInt(10) == 0 && this.onGround) {
                ...
                f2 = MathHelper.sqrt_double((double)(d0 * d0 + d1 * d1));
                if (this.isSpeedy) {
                    this.motionX = d0 / (double)f2 * 2.0;
                    this.motionZ = d1 / (double)f2 * 2.0;
                } else {
                    this.motionX = d0 / (double)f2 * 0.75;
                    this.motionZ = d1 / (double)f2 * 0.75;
                }
                this.jump();
            ...
            if (!this.canEntityBeSeen((Entity)this.getAttackTarget())) {
                ...
                if (this.isSpeedy) {
                    ...
                    this.motionZ = d1 / (double)f2 * 1.0;
                } else {
                    this.motionX = d0 / (double)f2 * 0.35;
                    this.motionZ = d1 / (double)f2 * 0.35;
                }
            }
        }
        ...
        if (this.master != null) {
            ...
            if (list != null && !list.isEmpty()) {
                for (int i1 = 0; i1 < list.size(); ++i1) {
                    ...
                    if (entity == null || !(entity instanceof EntityCaveSpiderTitan)) continue;
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_) {
        if (this.rand.nextInt(this.worldObj.difficultySetting == EnumDifficulty.NORMAL ? 25 : (this.worldObj.difficultySetting == EnumDifficulty.HARD ? 2 : 500)) == 0) {
            switch (this.rand.nextInt(10)) {
                ...
                case 2: {
                    this.addPotionEffect(new PotionEffect(Potion.invisibility.id, Integer.MAX_VALUE, 0, false));
