...
ITemplar {
    ...
    public void TransformEntity(Entity entity) {
        net.minecraft.theTitans.util.FastExplosion.newExplosion(entity.worldObj, entity, entity.posX, entity.posY, entity.posZ, 8.0f, true, entity.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing"));
