...
public class AnimationPigZombieTitanAttack2
extends AIAnimation {
    ...
    public void updateTask() {
        ...
        if (this.entity.getAnimTick() == 60 || this.entity.getAnimTick() == 104) {
            ...
            List list11 = this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.boundingBox.expand(32.0, 2.0, 32.0));
