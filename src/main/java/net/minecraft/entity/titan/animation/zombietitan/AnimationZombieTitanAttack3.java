...
extends AIAnimation {
    ...
    public boolean continueExecuting() {
        return this.entity.animTick > this.getDuration() || this.entity.isStunned || (!this.entity.isSwordSoft() ? this.entity.worldObj.getBlock((int)this.entity.posX, (int)this.entity.posY - 1, (int)this.entity.posZ).getExplosionResistance((Entity)this.entity) > 500.0f : this.entity.worldObj.getBlock((int)this.entity.posX, (int)this.entity.posY - 1, (int)this.entity.posZ).getExplosionResistance((Entity)this.entity) <= 1.5f) || !this.entity.isArmed() ? false : super.continueExecuting();
    }
    ...
    public void updateTask() {
        ...
        if (this.entity.getAnimTick() == 120) {
            ...
            List list11 = this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.boundingBox.expand(24.0, 2.0, 24.0).offset(dx, -2.0, dz));
