...
public class AnimationZombieTitanAntiTitanAttack
extends AIAnimation {
    private EntityZombieTitan entity;

    public AnimationZombieTitanAntiTitanAttack(EntityZombieTitan test) {
        super(test);
        this.entity = test;
    }
    ...
    public void updateTask() {
        ...
        if (this.entity.getAnimTick() == 12 && this.entity.getAttackTarget() != null) {
            ...
            if (this.entity.isArmored()) {
                ...
                this.entity.collideWithEntities(this.entity.body, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.body.boundingBox.expand(26.0, 26.0, 26.0)));
                this.entity.collideWithEntities(this.entity.body, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.body.boundingBox.expand(26.0, 26.0, 26.0)));
                this.entity.collideWithEntities(this.entity.body, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.body.boundingBox.expand(26.0, 26.0, 26.0)));
            }
