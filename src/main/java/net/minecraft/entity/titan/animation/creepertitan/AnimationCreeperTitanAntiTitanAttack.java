...
public class AnimationCreeperTitanAntiTitanAttack
extends AIAnimation {
    private EntityCreeperTitan entity;

    public AnimationCreeperTitanAntiTitanAttack(EntityCreeperTitan test) {
        super(test);
        this.entity = test;
    }
        ...
        if (this.entity.getAnimTick() == 12 && this.entity.getAttackTarget() != null) {
            ...
            if (list11 != null && !list11.isEmpty()) {
                for (int i1 = 0; i1 < list11.size(); ++i1) {
                    ...
                    this.entity.attackChoosenEntity(entity1, f, i);
                    this.entity.collideWithEntities(this.entity.body, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.body.boundingBox.expand(16.0, 16.0, 16.0)));
                    this.entity.collideWithEntities(this.entity.body, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.body.boundingBox.expand(16.0, 16.0, 16.0)));
                    this.entity.collideWithEntities(this.entity.body, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.body.boundingBox.expand(16.0, 16.0, 16.0)));
                    this.entity.collideWithEntities(this.entity.body, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.body.boundingBox.expand(16.0, 16.0, 16.0)));
                }
