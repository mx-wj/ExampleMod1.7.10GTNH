...
extends AIAnimation {
    ...
    public boolean continueExecuting() {
        return this.entity.animTick > 30 || this.entity.isStunned ? false : super.continueExecuting();
    }
    ...
    public void updateTask() {
        ...
        if (this.entity.getAnimTick() == 12 && this.entity.getAttackTarget() != null) {
            ...
            this.entity.collideWithEntities(this.entity.thorax, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.boundingBox.expand(48.0, 48.0, 48.0)));
            ...
            if (this.entity.isArmored()) {
                ...
                this.entity.collideWithEntities(this.entity.thorax, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.thorax.boundingBox.expand(26.0, 26.0, 26.0)));
                this.entity.collideWithEntities(this.entity.thorax, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.thorax.boundingBox.expand(26.0, 26.0, 26.0)));
                this.entity.collideWithEntities(this.entity.thorax, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.thorax.boundingBox.expand(26.0, 26.0, 26.0)));
            }
            if ((list11 = this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity.getAttackTarget(), this.entity.getAttackTarget().boundingBox.expand(8.0, 8.0, 8.0))) != null && !list11.isEmpty()) {
                for (int i1 = 0; i1 < list11.size(); ++i1) {
                    ...
                    this.entity.attackChoosenEntity(entity1, f, i);
                    this.entity.collideWithEntities(this.entity.thorax, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.thorax.boundingBox.expand(6.0, 6.0, 6.0)));
                    this.entity.collideWithEntities(this.entity.thorax, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.thorax.boundingBox.expand(6.0, 6.0, 6.0)));
                    this.entity.collideWithEntities(this.entity.thorax, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.thorax.boundingBox.expand(6.0, 6.0, 6.0)));
                    this.entity.collideWithEntities(this.entity.thorax, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.thorax.boundingBox.expand(6.0, 6.0, 6.0)));
                }
