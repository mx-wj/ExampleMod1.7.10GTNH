...
extends AIAnimation {
    ...
    public void updateTask() {
        ...
        if (this.entity.getAnimTick() == 24) {
            ...
            this.entity.collideWithEntities(this.entity.head, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.head.boundingBox.expand(18.0, 12.0, 18.0).offset(-((double)(f11 * d0)), -8.0, (double)(f4 * d0))));
            List list11 = this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.boundingBox.expand(12.0, 8.0, 12.0).offset(-((double)(f11 * d0)), -4.0, (double)(f4 * d0)));
