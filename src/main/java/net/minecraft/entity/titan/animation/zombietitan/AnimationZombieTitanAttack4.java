...
extends AIAnimation {
    ...
    public void updateTask() {
        ...
        if (this.entity.getAnimTick() >= 106 && this.entity.getAnimTick() <= 110) {
            double d8 = this.entity.isArmed() ? 28.0 : 6.0;
            ...
            this.entity.collideWithEntities(this.entity.body, this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.body.boundingBox.expand(24.0, 8.0, 24.0)));
            List list11 = this.entity.worldObj.getEntitiesWithinAABBExcludingEntity((Entity)this.entity, this.entity.boundingBox.expand(14.0, 1.0, 14.0).offset(dx, 0.0, dz));
