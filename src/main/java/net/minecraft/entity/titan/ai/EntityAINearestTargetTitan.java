...
extends EntityAITarget {
    ...
    protected boolean isSuitableTarget(EntityLivingBase p_75296_1_, boolean p_75296_2_) {
        ...
        if (p_75296_1_ instanceof EntityTitanSpirit) {
            return false;
        }
        if ((this.taskOwner instanceof EntityCreeperTitan || this.taskOwner instanceof EntityCreeperMinion) && p_75296_1_ instanceof EntityPlayer && ((EntityPlayer)p_75296_1_).getCommandSenderName() == "Boom337317") {
            return false;
        }
        if ((this.taskOwner instanceof EntityTitan || this.taskOwner instanceof EntityMob) && p_75296_1_ instanceof EntityPlayer && ((EntityPlayer)p_75296_1_).getCommandSenderName() == "Umbrella_Ghast") {
            return false;
        }
        ...
        if (this.taskOwner instanceof EntityTitan && this.taskOwner.getAITarget() != null) {
            return false;
        }
