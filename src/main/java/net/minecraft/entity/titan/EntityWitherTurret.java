...
implements IRangedAttackMob {
    ...
    public EntityWitherTurret(World worldIn) {
        super(worldIn);
        this.isImmuneToFire = true;
        this.preventEntitySpawning = true;
        this.setSize(0.35f, 2.5f);
    }
    ...
    public void onLivingUpdate() {
        ...
        if (list11 != null && !list11.isEmpty() && this.getAttackTarget() == null) {
            for (int i1 = 0; i1 < list11.size(); ++i1) {
                ...
                if (entity instanceof EntityLivingBase && entity != null && entity.isEntityAlive() && this.getAttackTarget() == null && this.canTargetEntity((EntityLivingBase)entity) && this.canEntityBeSeen(entity) && entity.posY + (double)entity.getEyeHeight() >= this.posY + 6.0) {
        ...
        if (this.getAttackTarget() != null && !this.worldObj.isRemote) {
            ...
            if (!this.getAttackTarget().isEntityAlive() || this.getAttackTarget().isDead || this.getAttackTarget().posY + (double)this.getAttackTarget().getEyeHeight() < this.posY + 6.0 || this.getAttackTarget().getDistanceSqToEntity((Entity)this) > 10000.0 || !this.canEntityBeSeen((Entity)this.getAttackTarget())) {
    ...
    private void launchWitherSkullToEntity(int p_82216_1_, EntityLivingBase p_82216_2_) {
        this.launchWitherSkullToCoords(p_82216_1_, p_82216_2_.posX, p_82216_2_.posY + (double)p_82216_2_.getEyeHeight(), p_82216_2_.posZ, p_82216_1_ == 0 && this.rand.nextFloat() < 0.001f);
    }

    private void launchWitherSkullToCoords(int p_82209_1_, double p_82209_2_, double p_82209_4_, double p_82209_6_, boolean p_82209_8_) {
        if (this.shootingTimer <= 0) {
            this.playSound("thetitans:turretShoot", 6.0f, 1.0f);
            ...
            EntityHomingWitherSkull entitywitherskull = new EntityHomingWitherSkull(this.worldObj, (EntityLivingBase)this, d6, d7, d8);
            if (p_82209_8_) {
                entitywitherskull.setInvulnerable(true);
            }
            if (this.getAttackTarget() != null) {
                entitywitherskull.assginedEntity = this.getAttackTarget();
            }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount) {
        ...
        if (entity instanceof EntityLivingBase && !this.isEntityInvulnerable() && entity.posY + (double)entity.getEyeHeight() >= this.posY + 8.0) {
            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                if (entity1 instanceof EntityWitherTurret) {
                    EntityWitherTurret entitypigzombie = (EntityWitherTurret)entity1;
    ...
    protected void onDeathUpdate() {
        ...
        if (!this.worldObj.isRemote) {
            this.playSound("thetitans:turretDeath", 6.0f, 1.0f);
            net.minecraft.theTitans.util.FastExplosion.createExplosion(this.worldObj, (Entity)null, this.posX, this.posY - 1.0, this.posZ, 2.0f, true);
        }
    }
