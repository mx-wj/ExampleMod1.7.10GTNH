...
public class EntityGargoyleTitanFireball
extends EntityFireball {
    ...
    protected void onImpact(MovingObjectPosition movingObject) {
        if (!this.worldObj.isRemote) {
            float f = TheTitans.NightmareMode ? 9000.0f : 3000.0f;
            if (movingObject.entityHit != null && !(movingObject.entityHit instanceof EntityGargoyleTitan)) {
                this.attackEntityFrom(DamageSource.causeFireballDamage((EntityFireball)this, (Entity)(this.shootingEntity != null ? this.shootingEntity : this)), f);
            }
    ...
    public void setBlockType(int p_82201_1_) {
        this.dataWatcher.updateObject(10, (Object)((byte)p_82201_1_));
    }
    ...
    public void setModelVarient(int p_82201_1_) {
        this.dataWatcher.updateObject(11, (Object)((byte)p_82201_1_));
    }
}
